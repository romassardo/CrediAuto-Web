                        ...
                        {items.map((m, idx) => (
                          <div key={idx} className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div className={`mt-1 p-3 rounded-lg whitespace-pre-wrap border ${m.who === 'ADMIN' ? 'bg-brand-primary-600/10 border-brand-primary-600/30 text-gray-900' : 'bg-orange-50 border-orange-200 text-orange-900'}`}>
                                {m.text}
                              </div>
                            </div>
                          </div>
